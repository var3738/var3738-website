...
export default function StrategicAlignment({ isModal = false }: StrategicAlignmentProps) {
  const content = (
    <div className="max-w-7xl mx-auto relative z-10">
      <div className={`mb-20 ${isModal ? 'text-center' : 'text-center lg:text-left'}`}>
        ...
        <h2 className={`${isModal ? 'text-4xl' : 'text-4xl lg:text-6xl'} font-black mb-10 tracking-tighter leading-none`}>
          SHARED OBJECTIVES <br />
          <span className="text-primary italic text-3xl lg:text-5xl">WITH U.S. EMBASSY</span>
        </h2>
      </div>
